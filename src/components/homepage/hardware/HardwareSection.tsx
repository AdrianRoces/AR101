  ...
  const powerShieldsData = [
    {
      ...
      imageUrl: "/src/assets/images/Li-ion 3.7V 2200mAh Cell.jpg"
    },
    {
      ...
      imageUrl: "/src/assets/images/Battery Holder (2-cell).jpg"
    },
    {
      ...
      imageUrl: "/src/assets/images/Charging Module TP4056 (USB-C).jpg"
    },
    {
      ...
      imageUrl: "/src/assets/images/Step-Up Converter (Boost).jpg"
    },
    {
      ...
      imageUrl: "/src/assets/images/Relay Module (4-Channel).jpg"
    },
    {
      ...
      imageUrl: "/src/assets/images/Water Pump (12V DC).jpg"
    },
    {
      ...
      imageUrl: "/src/assets/images/Solenoid Valve.jpg"
    },
    {
    ...
    },
    {
      ...
      imageUrl: "/src/assets/images/Logic Level Converter.jpg"
    },
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 sm:mb-12 animate-fade-in-up">
          <HardwareCard
            ...
            imageUrl="/src/assets/images/FlameSensors.jpg"
            imagePosition="right"
          />
        </div>
        ...
        <div className="mb-8 sm:mb-12 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          <HardwareCard
            ...
            imageUrl="/src/assets/images/MQ2GasSensor-.jpg"
            imagePosition="left"
          />
        </div>
